...
function TableTrabajadoresComponent({ trabajadores, onEdit, refetch }) {
 ...
 const deleteMutation = useMutation(trabajadorDeleteServices, {
    onSuccess: () => {
      setSnackbar({ open: true, message: "Trabajador dado de baja con éxito.", severity: "success" });
      refetch();
    },
    onError: (error) => {
        ...
        <Table>
          <TableHead className={classes.tableHeader}>
            <TableRow>
              ...
              <TableCell sx={{ color: "#fff", fontWeight: "bold" }}>Apellido Paterno</TableCell>
              <TableCell sx={{ color: "#fff", fontWeight: "bold" }}>Apellido Materno</TableCell>
              <TableCell sx={{ color: "#fff", fontWeight: "bold" }}>Fecha de Contratación</TableCell>
          ...
          <TableBody>
            {trabajadores.map((trabajador) => (
              <TableRow key={trabajador.id_trabajador}>
                ...
                <TableCell style={{ textTransform: "capitalize" }}>{trabajador.rol?.nombre}</TableCell>
