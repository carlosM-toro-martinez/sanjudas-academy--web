        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 2 }}>
            ...
            {mutation.isSuccess && (
                ...
                <Table>
                    ...
                    <TableRow>
                        <TableCell align="center" style={{ color: "#fff", fontWeight: "bold" }}>Fecha</TableCell>
                        <TableCell align="center" style={{ color: "#fff", fontWeight: "bold" }}>Método de Pago</TableCell>
                        <TableCell align="center" style={{ color: "#fff", fontWeight: "bold" }}>Nombre del Cliente</TableCell>
                        <TableCell align="center" style={{ color: "#fff", fontWeight: "bold" }}>Apellido del Cliente</TableCell>
                        <TableCell align="center" style={{ color: "#fff", fontWeight: "bold" }}>Total</TableCell>
                    </TableRow>
                    </TableHead>
                    <TableBody>
